    ...
    <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 space-y-12">
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          We're here to help you get the most out of your exhibition experience. 
      ...
      <section className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="space-y-4">
          {faqList.map((faq, index) => (
            <div key={index} className="border border-gray-200 rounded-lg overflow-hidden transition-all hover:shadow-sm">
              <button
                className="w-full flex justify-between items-center p-5 font-medium text-left bg-gray-50 hover:bg-gray-100 transition"
              ...
              {openFAQIndex === index && (
                <div className="p-5 text-gray-700 bg-white whitespace-pre-line border-t border-gray-200">
                  {faq.answer}
                </div>
              )}
            </div>
