        ...
        <TabsContent value="floorplan" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-gray-600">Interactive floor plans showing room layouts and capacities</p>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Ground Floor */}
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg">Ground Floor</h3>
                  <div className="relative aspect-square bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 overflow-hidden">
                    <Image
                      src="/placeholder.svg?height=400&width=400&text=Ground+Floor+Plan"
                      alt="Ground Floor Plan"
                      fill
                      className="object-contain p-4"
                    />
                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-2">
                      <div className="text-xs font-medium">Ground Floor</div>
                      <div className="text-xs text-gray-600">Main Hall, Reception</div>
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      <span>Foyer</span>
                      <span className="font-medium">150 capacity</span>
                    </div>
                  </div>
                </div>
                ...
                {/* First Floor */}
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg">First Floor</h3>
                  <div className="relative aspect-square bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 overflow-hidden">
                    <Image
                      src="/placeholder.svg?height=400&width=400&text=First+Floor+Plan"
                      alt="First Floor Plan"
                      fill
                      className="object-contain p-4"
                    />
                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-2">
                      <div className="text-xs font-medium">First Floor</div>
                      <div className="text-xs text-gray-600">Conference Rooms</div>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                    ...
                    <div className="flex justify-between text-sm">
                      <span>Meeting Rooms (3)</span>
                      <span className="font-medium">25 each</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <h4 className="font-medium mb-2">Floor Plan Features</h4>
