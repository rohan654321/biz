...
import { Search, Share2, MapPin, Calendar, Heart, ChevronDown, ChevronLeft, ChevronRight, Loader2, Edit, Trash2, Save, X, Image as ImageIcon, Users, Tag, Clock } from "lucide-react"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        value={editingEvent.location?.country || ""}
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">General Admission Price ($)</label>
                      <Input
                        type="number"
